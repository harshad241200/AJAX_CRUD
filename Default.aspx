<%@ Page Title="Home Page" Language="C#"  AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AJX._Default" %>
   ...
   <button type="submit" class="btn btn-primary d-none updateUser">Update User</button>
    ...
    <tr>
      ...
      <td>
          ...
          <button class="btn-sm btn btn-danger rounded-0" id="deleteuser"  data-id="<%#Eval("id") %>">Delete</button></td>
    </tr>
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
      ...
      <script>
          $(document).ready(function () {                         //Ready function start
              $('#userTable').DataTable();
              $(".addUser").on('click', function () {               //onclick function
                  let uname = $("#uname").val();
              ...
              //Exit User
              $("#userTable").on('click', '.editUsers', function () {        //onclick event
                  let id = $(this).attr("data-id")
                  let name = $(this).attr("data-name")
                  let username = $(this).attr("data-username");
                  let email = $(this).attr("data-email");
                  console.log('name---------->', name, username, email,id)
              ...
              //update 
              $(".updateUser").on('click', function () {                     //onclick function
                  let id = $("#hiddenid").val();
                  let uname = $("#uname").val();
                  let username = $("#username").val();
                  let uemail = $("#uemail").val();
                  $.ajax({                                           //$ Ajax open
                      ...
                      data: "{'uname':'" + uname + "','username':'" + username + "','uemail':'" + uemail + "','id':'" + id + "'}",
                      success: function (resp) {
                          console.log('Response =======>', resp)
                          swal("Good job!", "You clicked the button!", "success").then(function () {
                              location.reload()
              ...
              })            //update code end               // //onclick function end

              //delete
              $("#userTable").on('click', '#deleteuser', function () {       //onclick event
              ...
              })         //delete code End               //onclick event close
